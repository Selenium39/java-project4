...
<c:when test="${sessionScope.url=='/findPassword'}">
<h1 class="error"><a href="index.jsp">找回密码失败,５秒后跳转首页，如未跳转，点击此处跳转</a></h1>
</c:when>
<c:when test="${sessionScope.url=='/changePassword'}">
<h1 class="error"><a href="index.jsp">修改密码失败,５秒后跳转首页，如未跳转，点击此处跳转</a></h1>
</c:when>
